...
namespace Estacionamento.Migrations
{
    ...
    [Migration("20250509010901_Alterando_Estacionamento")]
    partial class Alterando_Estacionamento
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Estacionamento.Models.AluguelVaga", b =>
                {
                    ...
                    b.Property<int>("VagaEstacionamentoId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("VagaEstacionamentoId1");
            ...
            modelBuilder.Entity("Estacionamento.Models.AluguelVaga", b =>
                {
                    ...
                    b.HasOne("Estacionamento.Models.VagaEstacionamento", "VagaEstacionamento")
                        .WithMany()
                        .HasForeignKey("VagaEstacionamentoId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
